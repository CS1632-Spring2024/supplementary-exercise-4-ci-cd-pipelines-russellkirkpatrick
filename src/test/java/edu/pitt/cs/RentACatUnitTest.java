...
public class RentACatUnitTest {
	...
	public void setUp() throws Exception {
		...
		//if(c1 == null) System.err.println("this is null");
		...
		// TODO: Fill in
		c2 = Cat.createInstance(InstanceType.MOCK, 2, "Old Deuteronomy");//IMPL?
		//if(c2 == null) System.err.println("this is null");
		...
		//if(c3 == null) System.err.println("this is null");
	...
	public void testGetCatNullNumCats0() {
		...
		//not interacting with a mock at all since we are testing the getcat(int) method which belongs to 
		try{
	...
	public void testRenameFailureNumCats0() {
		...
		//stdout.print("Invalid cat ID.\n");//test actual program output
	...
	public void testRenameNumCat3() {
		...
		r.addCat(c3);
		boolean test = r.renameCat(2,"Garfield");
		System.err.println("here is garfield" + c2.getName());
		assertTrue(test);
	...
	public void testRentCatFailureNumCats3() {
		...
		Boolean test = r.rentCat(2);
		assertFalse(test);
		assertEquals(out.toString(),"Sorry, Old Deuteronomy is not here!" + newline);
	...
	public void testReturnCatNumCats3() {
		...
		assertTrue(test);
		Mockito.verify(c2, Mockito.atLeastOnce()).returnCat();
		assertEquals(out.toString(),"Welcome back, Old Deuteronomy!" + newline);
	}
